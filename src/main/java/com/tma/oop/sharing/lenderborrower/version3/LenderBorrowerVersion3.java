package com.tma.oop.sharing.lenderborrower.version3;

import lombok.Getter;
import lombok.Setter;

public class LenderBorrowerVersion3 {
...
interface Lendable {
    boolean lendMoney(Borrower br, double amount);
    boolean getMoneyBackFrom(Borrower br, double amount);
}
...
class Company implements Lendable {
